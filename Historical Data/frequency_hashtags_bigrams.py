...
write_to_file(counter.most_common(15),'data/hashtags.json')
...
# print(counter.most_common(15))
write_to_file(counter.most_common(15),'data/mention.json')
...
# print(counter.most_common(15))
write_to_file(counter.most_common(15),'data/most_occurring_words.json')
...
print("Bigrams")
# print(counter.most_common(15))
write_to_file(counter.most_common(15),'data/bigrams.json')
